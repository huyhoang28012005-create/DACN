        ...
        <div className="flex-1 w-full lg:w-1/2 p-8 sm:p-12 md:p-14 bg-white dark:bg-slate-900 flex flex-col justify-center relative">
          ...
          <div className="w-full max-w-[380px] mx-auto relative z-10">
            ...
            <div className="text-center lg:text-left mb-8">
              <h2 className="text-[32px] font-black text-[#1E293B] dark:text-white tracking-tight mb-2">
                {t('login')}
              </h2>
            ...
            {showMfaInput ? (
              ...
              >
                <div className="space-y-2">
                  <label
                    className="block text-[14px] font-bold text-[#334155] dark:text-slate-300"
                    htmlFor="mfaCode"
                  >
                    {t('mfa_code_label')}
                  </label>
                ...
                <div className="flex items-center justify-between pt-2">
                  <label className="flex items-center gap-2.5 cursor-pointer group">
                    <div className="relative flex items-center justify-center">
                      <input
                        type="checkbox"
                        className="peer appearance-none w-5 h-5 border-2 border-[#CBD5E1] dark:border-slate-600 rounded md:rounded-md checked:bg-[#1E5FA5] dark:bg-blue-600 checked:border-[#1E5FA5] transition-colors cursor-pointer"
                      />
                      <svg
                    ...
                    <span className="text-[14px] font-medium text-[#475569] dark:text-slate-400 group-hover:text-[#1E293B] dark:group-hover:text-slate-200 transition-colors">
                      {t('remember_me')}
                    </span>
                  </label>
            ...
            <div className="mt-8 relative">
              ...
              <div className="relative flex justify-center text-[13px] font-medium">
                <span className="bg-white dark:bg-slate-900 px-4 text-[#94A3B8] dark:text-slate-500">
                  {t('or')}
                </span>
              </div>
            </div>
            ...
            <div className="mt-8 text-center bg-[#F8FAFC] dark:bg-slate-800/50 rounded-xl p-4 border border-[#E2E8F0] dark:border-slate-700">
              <p className="text-[14px] text-[#64748B] dark:text-slate-400 font-medium">
                ...
                <a
                  href="#"
                  className="text-[#1E5FA5] dark:text-blue-400 font-bold hover:underline ml-1 transition-colors"
                >
                  {t('contact_admin')}
                </a>
              </p>
